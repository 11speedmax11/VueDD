    ...
    <div class="profile__body">
      <div class="profile__header">
        ...
        <div class="profile__dropdownmenu">
          <DropDownButton
            ...
            xClass="card__svg"
          >
            <CustomButton classButton="profile__edit">Редактировать</CustomButton>
            <CustomButton classButton="profile__password">Изменить пароль</CustomButton>
            <CustomButton classButton="profile__tasks">Просмотр задач пользователя </CustomButton>
          </DropDownButton>
        </div>
      </div>
      <div class="profile__about">
        ...
        <div class="profile__text">
          ...
          послушавшись рукописи, наш текст продолжил свой путь. Вскоре ему
          повстречался коварный составитель рекламных текстов, напоивший его
          языком и речью и заманивший в свое агенство, которое использовало его
          снова и снова в своих проектах. И если его не переписали, то живет он
          там до сих пор. Далеко-далеко за словесными горами в стране гласных и
          ...
          Однажды одна маленькая строчка р.
        </div>
      </div>
    </div>
  </div>
